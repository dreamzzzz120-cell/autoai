  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        ...
        >
          <Card className="min-w-[380px] pb-0 glass-heavy border-0 shadow-2xl shadow-black/5">
            {step === "signIn" ? (
              <>
                <CardHeader className="text-center pt-8">
                  ...
                  <CardDescription>
                    Evidence-first automotive diagnostics. Enter your email to
                    get started.
                  </CardDescription>
                </CardHeader>
                    ...
                    <div className="relative flex items-center gap-2">
                      <div className="relative flex-1">
                        ...
                        <Input
                          ...
                          type="email"
                          className="pl-9 bg-white/50 backdrop-blur-sm border-border/50 rounded-xl"
                          disabled={isLoading}
                          required
                        />
                      </div>
                    ...
                    <div className="mt-5">
                      <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                          <span className="bg-white/85 backdrop-blur-sm px-2 text-muted-foreground">
                            Or
                          </span>
                        </div>
                      </div>
                      ...
                      <Button
                        type="button"
                        variant="outline"
                        className="w-full mt-4 rounded-xl glass-subtle hover:glass-light transition-all duration-300"
            ...
            <div className="py-4 px-6 text-xs text-center text-muted-foreground glass-subtle border-t border-border/30 rounded-b-lg">
              Evidence-first diagnostics powered by{" "}
              <span className="font-semibold text-primary">MechanicAI</span>
            </div>
          </Card>
        </motion.div>
      </div>
