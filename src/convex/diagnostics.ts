...
function fallbackDiagnosis(message: string, machineHint = ""): DiagnosticResponse {
  ...
  if (/high voltage|hv battery|traction battery|orange cable/.test(text)) safety.push("High-voltage system risk: do not expose energized conductors or bypass interlocks.");
